...
if __name__ == "__main__":
    # Example Usage:
    register_user("john.doe", "P@sswOrd123")
    register_user("jane.smith", "secure_password")
    register_user("john.doe", "another_password") # Attempt to register existing user

    # Check if a user exists
    if user_exists("john.doe"):
        print("John Doe exists.")
    else:
        print("John Doe does not exist.")